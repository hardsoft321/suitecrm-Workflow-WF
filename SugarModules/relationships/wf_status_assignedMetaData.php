...
$dictionary['wf_status_assigned'] = array(
    ...
    'fields' => array (
     ...
     , 'indices' => array (
      ...
      , array('name' =>'idx_wf_st_assigned_rel', 'type' =>'index', 'fields'=>array('role_id', 'record_id', 'module', 'user_id'))
      , array('name' =>'idx_wf_st_norole_assigned_rel', 'type' =>'index', 'fields'=>array('status_id', 'record_id', 'module', 'user_id'))
